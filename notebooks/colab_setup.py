"""Colab bootstrap for the INF8225 segmentation experiments.
...
def setup(
    ...
    expected_dirs = ("experiments", "notebooks", "configs")
    if not all((project_root / name).is_dir() for name in expected_dirs):
        raise RuntimeError(
