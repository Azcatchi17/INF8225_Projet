...
Loads ``resnet50_wide_crop_fold_*.pth``, scores validation candidates with
3-slice context and the wider crop, and writes
``optimal_threshold_resnet50_wide_crop.{txt,json}``.

Usage (from repo root):
    python -m msd_implementation.pipelines.resnet50_wide_crop.calibrate_threshold
"""
