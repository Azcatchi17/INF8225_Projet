...
Reads the cached MedSAM wrapper from `msd_implementation.pipelines.dino_medsam_gemini`
...
from msd_implementation.pipelines.dino_medsam_gemini import config as _cfg
from msd_implementation.pipelines.dino_medsam_gemini import medsam
