...
Kept in the MSD implementation so we can sweep parameters without touching
`msd_implementation/pipelines/dino_medsam_gemini/medsam.py` (which is already branched on
