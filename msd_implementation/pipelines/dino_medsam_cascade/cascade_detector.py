...
cached model loader and bf16 fallback from msd_implementation/pipelines/dino_medsam_gemini/.
...
from msd_implementation.pipelines.dino_medsam_gemini import config as _base_config
from msd_implementation.pipelines.dino_medsam_gemini.models import get_dino_model
