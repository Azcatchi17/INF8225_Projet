...
from msd_implementation.pipelines.common.proposal_strategy import ProposalConfig, candidate_score
from msd_implementation.pipelines.three_slice_context.slice_stack import stack_3slice_image, stack_3slice_crop
...
def _crop_from_pre_stacked(stacked: np.ndarray, box, margin: int) -> np.ndarray | None:
    ...
    from msd_implementation.pipelines.common.proposal_strategy import clip_box, expand_box
