...
on the lesion alone. Output dataset: ``data/classifier_dataset_3slice_v2/``.

Usage (from repo root):
    python -m experiments.three_slice_v2.extract_v2
"""
...
output_base_dir = "data/classifier_dataset_3slice_v2"
