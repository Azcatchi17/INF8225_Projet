...
Reads ``optimal_threshold_3slice_v2.{txt,json}``, loads the
``resnet50_3slice_fold_*.pth`` ensemble, scores test candidates with the
wider 3-slice context, runs MedSAM on the survivors, and writes
``data/results/dice_final_report_msd_recall_3slice_v2.csv``.

Usage (from repo root):
    python -m experiments.three_slice_v2.test_v2
"""
...
THRESH_TXT = "optimal_threshold_3slice_v2.txt"
THRESH_JSON = "optimal_threshold_3slice_v2.json"
OUT_CSV = "data/results/dice_final_report_msd_recall_3slice_v2.csv"
