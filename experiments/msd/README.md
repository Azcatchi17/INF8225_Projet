...
`_shared/proposal_strategy.py` contains the candidate generation and
ensemble scoring logic reused across iterations 2-4. Iteration 1 is
...
python -m experiments.msd.<iteration>.<step>
```
