...
(``data/classifier_dataset_3slice/``). Saves checkpoints with the
``resnet_3slice_fold_*.pth`` prefix so they coexist with the original
2D ensemble.

Usage (from repo root):
    python -m experiments.three_slice.train_resnet_3slice
"""
...
THRESHOLD_PREFIX = "threshold_3slice_run"

TRAIN_DIR = "data/classifier_dataset_3slice/train"
VAL_DIR = "data/classifier_dataset_3slice/val"
