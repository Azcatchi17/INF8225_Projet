...
from msd_recall_strategy import ProposalConfig, candidate_score
from experiments.three_slice.slice_stack import stack_3slice_image, stack_3slice_crop
...
def _crop_from_pre_stacked(stacked: np.ndarray, box, margin: int) -> np.ndarray | None:
    ...
    from msd_recall_strategy import clip_box, expand_box
