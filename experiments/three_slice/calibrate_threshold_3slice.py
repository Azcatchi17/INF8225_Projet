...
Loads the ``resnet_3slice_fold_*.pth`` ensemble, scores validation
candidates with 3-slice context, and writes calibrated thresholds to
``optimal_threshold_3slice.{txt,json}``.

Usage (from repo root):
    python -m experiments.three_slice.calibrate_threshold_3slice
"""
...
OUT_TXT = "optimal_threshold_3slice.txt"
OUT_JSON = "optimal_threshold_3slice.json"
OUT_CSV = "data/results/calibration_threshold_3slice.csv"
OUT_SWEEP = "data/results/threshold_sweep_3slice.csv"
