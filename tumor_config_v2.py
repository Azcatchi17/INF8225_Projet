...
train_dataloader = dict(
    batch_size=1, # SÉCURITÉ VRAM : Réduit à 1 pour éviter tout crash
    num_workers=2,
...
# 5. Paramètres d'entraînement : Stabilité et Vitesse

# A. AMP (Automatic Mixed Precision) : Divise l'utilisation de la VRAM par 2
fp16 = dict(loss_scale='dynamic')

# B. Accumulation de Gradients : Simule un batch size de 4 malgré le batch réel de 1
optim_wrapper = dict(
    type='OptimWrapper',
...
# C. Allongement de l'entraînement : 25 époques pour compenser la difficulté de MSD
...
# D. Early Stopping assoupli : On laisse plus de temps au modèle pour sortir d'un plateau
custom_hooks = [
    dict(
